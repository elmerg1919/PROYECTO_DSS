...
<body>
    ...
    <form action="nueva-contra-cliente.php" method="POST">
        <h2>Nueva contraseña</h2>
        <label for="username">Usuario</label><br>
        <input type="text" name="username" value="<?php echo $_SESSION['id_user_contra'] ?>" readonly><br>
...
if (!empty($_POST)) {
    ...
    if ($pass1 == $pass2) {
        ...
        header("Location: nueva-contra-cliente.php?mensaje=Las contraseñas no coinciden.");
    }
}
?>