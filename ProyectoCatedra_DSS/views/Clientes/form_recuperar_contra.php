...
<body>
    ...
    <div class="contenedor">
        <div class="form">
            ...
            <form action="../../controllers/Clientes/recuperar_contra.php" method="POST">
                <label for="username" class="form-label">Ingresa tu nombre de usuario:</label><br>
            ...
            <?php } ?>
            <a href="clientes.php"><button class="btn btn-dark">Regresar</button></a>
        </div>
    </div>
