...
class MetodosLoginAdmin
{
    public function buscarUsuario($usuario, $correo, $pass, $estadoH)
    {
        ...
        if ($query->rowCount() == 1) {
            ...
            header("Location: ../../views/Admin/admin.php?mensaje=Los datos ingresados no son correctos.");
        }
    }
    ...
    public function buscarUsuarioContra($correo, $username, $estadoH)
    {
        ...
        if ($query->rowCount() == 1) {
            ...
            header("Location: ../../views/Admin/form_nueva_contra.php");
        } else {
            header("Location: ../../views/Admin/form_recuperar_contra.php?mensaje=No existe un usuario con las credenciales ingresadas.");
        }
    }
